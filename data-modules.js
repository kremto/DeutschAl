    ...
    },
{
    ...
    ,{
      id:'a2m15', num:15, title:'Formelle E-Mail',
      sub:'Email formal — punë, autoritete, zyra',
      story:{
        ep:'Episodi 15', title:'Dioni shkruan email-in e parë formal',
        narr:'Dioni duhet të shkruajë email tek punëdhënësi i tij i ri — kompania TechWien. Është hera e parë dhe është nervoz.',
        lines:[
          {speaker:'Dion', de:'Klea, ich muss eine formelle E-Mail an meinen Chef schreiben. Wie fange ich an?', sq:'Klea, duhet të shkruaj email formal tek shefi. Si filloj?'},
          {speaker:'Klea', de:'Bei formellen E-Mails beginnst du immer mit "Sehr geehrter" oder "Sehr geehrte".', sq:'Në email formal filloni me "Sehr geehrter" ose "Sehr geehrte".'},
          {speaker:'Dion', de:'Und wenn ich den Namen nicht kenne?', sq:'Po nëse nuk e di emrin?'},
          {speaker:'Klea', de:'Dann schreibst du: "Sehr geehrte Damen und Herren,"', sq:'Atëherë: "Sehr geehrte Damen und Herren,"'},
          {speaker:'Dion', de:'Und am Ende der E-Mail?', sq:'Dhe në fund?'},
          {speaker:'Klea', de:'Immer "Mit freundlichen Grüßen" — das ist Standard in Deutschland.', sq:'Gjithmonë "Mit freundlichen Grüßen" — standard gjerman.'},
          {speaker:'Dion', de:'Niemals "Viele Grüße" bei formellen Mails?', sq:'Asnjëherë "Viele Grüße" në email formal?'},
          {speaker:'Klea', de:'Nein! Das wäre zu informal für einen Chef oder eine Behörde.', sq:'Jo! Shumë informale për shef ose autoritet.'},
          {speaker:'Dion', de:'In Kosovo ist das anders — wir sind direkter.', sq:'Në Kosovë është ndryshe — jemi më direkt.'},
          {speaker:'Klea', de:'In Deutschland ist Förmlichkeit sehr wichtig — besonders im Berufsleben.', sq:'Në Gjermani formaliteti është shumë i rëndësishëm — veçanërisht në punë.'},
          {speaker:'Dion', de:'Danke, Klea! Ich schreibe jetzt die E-Mail.', sq:'Faleminderit, Klea! Tani po shkruaj email-in.'},
          {speaker:'Klea', de:'Viel Erfolg! Zeig mir danach, was du geschrieben hast.', sq:'Suksese! Më trego pastaj çfarë ke shkruar.'}
        ]
      },
      vocab:[
        {de:'formell / informell', sq:'formal / informal', ex:'Eine Bewerbung ist formell.'},
        {de:'sehr geehrter / sehr geehrte', sq:'i nderuar / e nderuar', ex:'Sehr geehrter Herr Müller,'},
        {de:'mit freundlichen Grüßen', sq:'me respekt', ex:'Mit freundlichen Grüßen, Dion Hoxha'},
        {de:'hiermit', sq:'me këtë (formulë zyrtare)', ex:'Hiermit bewerbe ich mich für die Stelle.'},
        {de:'bezüglich', sq:'në lidhje me', ex:'Bezüglich Ihrer Anfrage vom 5. Mai...'},
        {de:'die Anfrage', sq:'kërkesa', ex:'Ich habe eine Anfrage bezüglich meines Vertrags.'},
        {de:'der Termin', sq:'takimi i caktuar', ex:'Ich möchte einen Termin vereinbaren.'},
        {de:'vereinbaren', sq:'caktoj, rregulloj', ex:'Können wir einen Termin vereinbaren?'},
        {de:'im Voraus', sq:'paraprakisht', ex:'Ich bedanke mich im Voraus.'},
        {de:'sich bewerben', sq:'aplikoj për punë', ex:'Ich bewerbe mich für die Stelle.'},
        {de:'anbei', sq:'bashkangjitur', ex:'Anbei finden Sie meinen Lebenslauf.'},
        {de:'hochachtungsvoll', sq:'me shumë respekt (shumë formal)', ex:'Hochachtungsvoll, Dion Hoxha'}
      ],
      grammar:[
        {title:'Struktura e Email-it Formal',
         body:'Email-i formal ka strukturë strikte. Çdo gabim mund të duket joprofesional!',
         table:{heads:['Pjesa','Gjermanisht','Shqip'],
                rows:[
                  ['Fillimi me emër','Sehr geehrter Herr Müller,','I nderuar Zotëri Müller,'],
                  ['Fillimi pa emër','Sehr geehrte Damen und Herren,','Të nderuara zonja dhe zotërinj,'],
                  ['Hyrja','Ich schreibe Ihnen bezüglich...','Po ju shkruaj në lidhje me...'],
                  ['Tema','Hiermit möchte ich...','Me këtë dua të...'],
                  ['Fundi','Ich bedanke mich im Voraus.','Ju falënderoj paraprakisht.'],
                  ['Lamtumirë','Mit freundlichen Grüßen,','Me respekt,'],
                  ['Emri','Dion Hoxha','Dion Hoxha']
                ]},
         examples:['Sehr geehrter Herr Bauer,','ich schreibe Ihnen bezüglich meines Vertrags.','Mit freundlichen Grüßen, Dion Hoxha']},
        {title:'Formal vs Informal — Krahasimi',
         body:'Dallimet kryesore:',
         table:{heads:['','Formal','Informal'],
                rows:[
                  ['Fillimi','Sehr geehrter/e...','Hallo / Liebe/r...'],
                  ['Ti/Ju','Sie (S të madhe)','du'],
                  ['Fundi','Mit freundlichen Grüßen','Viele Grüße / Bis bald'],
                  ['Gjuha','Precize, pa shkurtesa','E lirë, shkurtesa OK'],
                  ['Kur','Punë, autoritet','Miq, familje']
                ]},
         examples:['Formal: Könnten Sie mir bitte mitteilen?','Informal: Kannst du mir sagen?']},
        {title:'Formulat kyçe formale',
         body:'Mëso këto përmendësh!',
         table:{heads:['Formula','Kuptimi'],
                rows:[
                  ['Ich beziehe mich auf...','Referoj tek...'],
                  ['Ich möchte Sie bitten,...','Dua t\'ju kërkoj,...'],
                  ['Ich bedanke mich im Voraus.','Ju falënderoj paraprakisht.'],
                  ['Ich freue mich auf Ihre Antwort.','Pres përgjigjen tuaj.'],
                  ['Anbei finden Sie...','Bashkangjitur gjeni...'],
                  ['Hiermit bestätige ich...','Me këtë konfirmoj...']
                ]},
         examples:['Anbei finden Sie meinen Lebenslauf.','Ich möchte Sie bitten, mir einen Termin zu geben.']}
      ],
      exercises:[
        {type:'mc', q:'Si fillon email formal tek Zotëri Müller?',
         opts:['Hallo Herr Müller,','Hey Müller!','Sehr geehrter Herr Müller,','Lieber Müller,'], a:2,
         exp:'"Sehr geehrter Herr [Mbiemri]," = fillimi standard formal për mashkull.'},
        {type:'mc', q:'Lamtumirë formale:',
         opts:['Tschüss!','Bis bald!','Viele Grüße','Mit freundlichen Grüßen'], a:3,
         exp:'"Mit freundlichen Grüßen" = lamtumirë standarde formale.'},
        {type:'mc', q:'Pa emër → fillimi:',
         opts:['Hallo zusammen,','Sehr geehrte Damen und Herren,','Liebe alle,','Guten Tag,'], a:1,
         exp:'"Sehr geehrte Damen und Herren," kur nuk dini emrin.'},
        {type:'mc', q:'Në email formal përdoret:',
         opts:['du','ihr','Sie (S të madhe)','er/sie'], a:2,
         exp:'Gjithmonë "Sie" me S të madhe = forma e respektit.'},
        {type:'mc', q:'"Anbei finden Sie..." = ?',
         opts:['Ju pyes...','Bashkangjitur gjeni...','Ju falënderoj...','Referoj tek...'], a:1,
         exp:'"Anbei finden Sie..." = bashkangjitur gjeni — standard për bashkëngjitje.'},
        {type:'mc', q:'"Ich bedanke mich im Voraus" = ?',
         opts:['Pres me kënaqësi','Ju falënderoj paraprakisht','Dua të takohem','Po ju shkruaj'], a:1,
         exp:'"Ich bedanke mich im Voraus." = falënderim paraprak — shumë i zakonshëm.'},
        {type:'mc', q:'Si thuhet "dua t\'ju kërkoj" formal?',
         opts:['Ich will...','Ich möchte Sie bitten,...','Ich brauche...','Ich frage...'], a:1,
         exp:'"Ich möchte Sie bitten,..." = forma e sjellshme profesionale.'},
        {type:'mc', q:'"Bezüglich meiner Anfrage" = ?',
         opts:['Pas takimit','Në lidhje me kërkesën time','Para kontratës','Gjatë punës'], a:1,
         exp:'"bezüglich" = në lidhje me. "Anfrage" = kërkesë.'},
        {type:'mc', q:'Emoji në email formal:',
         opts:['OK disa','Vetëm 1-2','Kurrë','Gjithmonë'], a:2,
         exp:'Emoji KURRË në email formal! Gjuha duhet profesionale.'},
        {type:'mc', q:'Email formal tek Behörde (autoritet):',
         opts:['Hallo!','Liebe Behörde,','Sehr geehrte Damen und Herren,','Hey,'], a:2,
         exp:'"Sehr geehrte Damen und Herren," — gjithmonë kur shkruani te autoritete.'}
      ],
      quiz:[
        {q:'Fillimi formal (mashkull):', opts:['Hallo Herr X,','Lieber Herr X,','Sehr geehrter Herr X,','Hey Herr X,'], a:2},
        {q:'Lamtumirë standarde formale:', opts:['Tschüss','Bis bald','Viele Grüße','Mit freundlichen Grüßen'], a:3},
        {q:'Pa emër → fillimi:', opts:['Hallo alle,','Sehr geehrte Damen und Herren,','Liebe Freunde,','Guten Morgen,'], a:1},
        {q:'Në email formal:', opts:['du','ihr','Sie','er'], a:2},
        {q:'"Anbei finden Sie" = ?', opts:['Ju pyes','Bashkangjitur gjeni','Ju falënderoj','Pres'], a:1},
        {q:'"Ich bedanke mich im Voraus" = ?', opts:['Pres me kënaqësi','Ju falënderoj paraprakisht','Dua të takohem','Po shkruaj'], a:1},
        {q:'Emoji formal:', opts:['OK','Vetëm 1','Kurrë','Gjithmonë'], a:2},
        {q:'"bezüglich" = ?', opts:['Para','Pas','Gjatë','Në lidhje me'], a:3},
        {q:'"Ich möchte Sie bitten" = ?', opts:['Falënderoj','Informoj','Kërkoj','Takoj'], a:2},
        {q:'Sie ose du — email formal?', opts:['du=formal','Sie=informal','Sie=formal','Njëlloj'], a:2}
      ]
    }
  ],
  B1: [
